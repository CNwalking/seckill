...
public class CodeGenerator {
    //JDBC配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/miaosha?useUnicode=true&characterEncoding=utf8&autoReconnect=true";
    ...
    public static void main(String[] args) {
        List<String> genCodeList = new ArrayList<>();
        genCodeList.add("user_info");
        genCodeList.add("item");
        genCodeList.add("item_stock");
        genCodeList.add("order_info");
        genCodeList.add("promo");
        genCodeList.add("sequence_info");
        genCodeList.add("stock_log");
        genCodeList.add("user_password");
        for (String ele : genCodeList) {
            genCode(ele);
        }
//        genCode("user_info");
